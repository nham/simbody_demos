...
int main() {
    ...
    MobilizedBody::Pin pend1(matter.Ground(), Transform(Vec3(1, 0, 0)),
            pendBody, Transform(Vec3(1, 0, -1)));
    //MobilizedBody::Pin pend2(pend1, Transform(Vec3(2, 1, 0)),
